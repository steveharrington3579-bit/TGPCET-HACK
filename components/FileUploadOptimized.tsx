...
export default function FileUploadOptimized({ onParsed, isLoading = false }: FileUploadProps) {
  ...
  const handleFile = useCallback(async (file: File) => {
    ...
    if (processingState.isProcessing || processingState.isLoading) {
      return;
    }
  ...
  const isDisabled = processingState.isProcessing || processingState.isLoading;
